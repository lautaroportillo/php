...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-6 form-group">
            ...
            <input type="text" class="form-control" id="txtPrecioUniCurrency" value="" required>
        </div>
        <div class="col-6 form-group">
            <label for="txtCantidad">Cantidad</label>
            <input type="text" class="form-control" name="txtCantidad" id="txtCantidad" value="" required>
            <span id="msgStock" class="text-danger" style="display:none;">No hay Stock Suficuente</span>
        </div>
        <div class="col-6 form-group">
